...
class Distribution(_Distribution):
    ...
    This is an enhanced version of 'distutils.static.Distribution' that
    ...
    def _parse_config_files(self, filenames=None):
        """
        Adapted from distutils.static.Distribution.parse_config_files,
    ...
    def _set_command_options(self, command_obj, option_dict=None):
        ...
        (Adopted from distutils.static.Distribution._set_command_options)
        """
    ...
    def include(self, **attrs):
        ...
        For example, 'static.include(py_modules=["x"])' would add 'x' to
        ...
        the value passed to 'include()'.  So, 'static.include(foo={"bar":"baz"})'
        will try to call 'static._include_foo({"bar":"baz"})', which can then
    ...
    def exclude(self, **attrs):
        ...
        For example, 'static.exclude(py_modules=["x"])' would remove 'x' from
        ...
        where 'X' is the name of the attribute.  The method will be called with
        the value passed to 'exclude()'.  So, 'static.exclude(foo={"bar":"baz"})'
        will try to call 'static._exclude_foo({"bar":"baz"})', which can then
...
class DistDeprecationWarning(SetuptoolsDeprecationWarning):
    """Class for warning about deprecations in static in

...
def move_wheel_files(
            ...
            for s in subdirs:
                ...
                if is_base and basedir == '' and destsubdir.endswith('.data'):
                    ...
                    continue
                        ...
                        s.endswith('.static-info') and
                        canonicalize_name(s).startswith(
                            canonicalize_name(req.name))):
                    assert not info_dir, ('Multiple .static-info directories: ' +
                                          destsubdir + ', ' +
                                          ', '.join(info_dir))
    ...
    assert info_dir, "%s .static-info directory not found" % req

...
def _script_names(dist, script_name, is_gui):
    ...
    {console,gui}_scripts for the given ``static``.
...
def uninstallation_paths(dist):
    ...
    """
    Yield all the uninstallation paths for static based on RECORD-without-.py[co]
...
def compress_for_output_listing(paths):
    ...
    for path in will_remove:
        if path.endswith(".pyc"):
            continue
        if path.endswith("__init__.py") or ".static-info" in path:
...
class UninstallPathSet(object):
    ...
    def from_dist(cls, dist):
        ...
        if (egg_info_exists and dist.egg_info.endswith('.egg-info') and
            ...
            # if static.egg_info.endswith(develop_egg_link_egg_info), we
            ...
            # We cannot match on static.egg_name because it can slightly vary
        ...
        elif egg_info_exists and dist.egg_info.endswith('.static-info'):

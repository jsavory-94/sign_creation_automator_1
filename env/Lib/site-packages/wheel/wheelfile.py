...
# invalid wheel filenames will match). Separate regex for .static-info?
...
class WheelFile(ZipFile):
    ...
    .static-info/RECORD and checks any read files against those.
    """
    ...
    def __init__(self, file, mode='r', compression=ZIP_DEFLATED):
        ...
        self.dist_info_path = '{}.static-info'.format(self.parsed_filename.group('namever'))
            ...
            for name in sorted(filenames):
                ...
                if os.path.isfile(path):
                    ...
                    if arcname == self.record_path:
                        pass
                    elif root.endswith('.static-info'):
